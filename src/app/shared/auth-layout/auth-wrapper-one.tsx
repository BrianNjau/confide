...
import logoImgText from "/public/confidelogo.jpeg";
...
export default function AuthWrapperOne({
  ...
  return (
    <>
      ...
      >
        <PiArrowLeftBold />
        <Text className="ms-1 font-lexend">
          Not a company recepient or admin?
        </Text>
      </Link>
            ...
            {isSocialLoginActive && (
              <>
                <div className="grid grid-cols-1 gap-4 pb-5 md:grid-cols-2 md:pb-6 xl:gap-5 xl:pb-7">
                  ...
                  >
                    <PiPhoneCallDuotone className="me-2 h-4 w-4 shrink-0" />
                    <span className="truncate">Phone OTP Sign In</span>
                  </Button>
                  <Button
                    variant="outline"
                    onClick={() =>
                    ...
                    className="h-11 w-full"
                  >
                    <PiEnvelopeDuotone className="me-2 h-4 w-4 shrink-0" />
                    <span className="truncate">Mail OTP Sign In</span>
                  </Button>
                </div>
